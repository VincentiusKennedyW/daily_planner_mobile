...
class TaskBinding extends Bindings {
  ...
  void dependencies() {
    ...
    Get.lazyPut<AssignToTaskController>(() => (AssignToTaskController()));
    Get.lazyPut<UpdateTaskController>(() => (UpdateTaskController()));
    Get.lazyPut<DeleteTaskController>(() => (DeleteTaskController()));
  }
}
